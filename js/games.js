        ...
        this.innerHTML = `
            ...
            <div class="container px-vw-5 py-vh-5">
                ...
                <div class="col-12 col-lg-7 text-lg-end" data-aos="fade-right">
                    <a href="img/games/KeyBound/KeyBound Cover.gif" data-lightbox="KeyBound" data-title="KeyBound Cover">
            ...
            <div class="container px-vw-5 py-vh-5">
                <div class="row d-flex align-items-center">
                <div class="col-12 col-lg-7 text-lg-end" data-aos="fade-right">
                    <a href="img/games/TimeBound/TimeBound Cover.gif" data-lightbox="TimeBound" data-title="TimeBound Cover">
            ...
            <div class="container px-vw-5">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <div class="d-flex justify-content-start align-items-center border-top border-secondary pt-3">
                        ...
                        <div>
                        <span class="h6 fw-5">
                            <a href="https://projectsrya.itch.io/" class="link-fancy link-fancy-light me-2" target="_blank"
                            rel="noopener">rya (:>)</a> </span><br />
                    ...
                    <!-- Colorful Review -->
                    <!-- <div class="rounded-5 bg-dark p-5 shadow mt-5 gradient" data-aos="zoom-in-left">
                        <div class="fs-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-star-fill" viewBox="0 0 16 16">
                            <path
                ...
                <div class="col-12 col-lg-6" style="padding-top: 48px">
                    ...
                    <!-- User -->
                    <div class="d-flex justify-content-start align-items-center border-top border-secondary pt-3">
                        <img src="img/people/users/robobarbie.png" width="96" height="96" class="rounded-circle me-3"
                        alt="a nice person" data-aos="fade" loading="lazy" />
                        <div>
                        <span class="h6 fw-5">
                            <a href="https://ldjam.com/users/robobarbie/" class="link-fancy link-fancy-light me-2"
                            target="_blank" rel="noopener">robobarbie</a> </span><br />
                    ...
                    <!-- User -->
                    <div class="d-flex justify-content-start align-items-center border-top border-secondary pt-3">
                        <img src="img/people/users/dan burns.png" width="96" height="96" class="rounded-circle me-3"
                        alt="a nice person" data-aos="fade" loading="lazy" />
                        <div>
                        <span class="h6 fw-5">
                            <a href="https://ldjam.com/users/dan-burns/" class="link-fancy link-fancy-light me-2"
                            target="_blank" rel="noopener">Dan
                            Burns</a> </span><br />
                        <small class="text-secondary">Game: KeyBound</small>
                        </div>
                    </div>
